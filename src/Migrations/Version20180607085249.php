 ...
 */
final class Version20180607085249 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, groupstage_id INT NOT NULL, name VARCHAR(50) NOT NULL, INDEX IDX_C4E0A61FD0D064E2 (groupstage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
